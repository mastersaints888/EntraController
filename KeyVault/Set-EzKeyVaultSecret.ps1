...
while ($true) {
    $answer = Read-Host "Would you like to Create or Update a secret(Y/N)? Selecting 'N' you will proceed to viewing keys and secrets"
